...
<html lang="en-us">
    <head>
            ...
            <link href="http://bootstrapstyler.com/preview/_/boardskin/templates/bootstyler/templates/bootstyler/bootstrap/templates/2013/bootstrap/css/bootstrap.min.css" rel="stylesheet">
            <link href="http://bootstrapstyler.com/preview/_/boardskin/templates/bootstyler/templates/bootstyler/bootstrap/templates/2013/images/icons/css/font-awesome.css" rel="stylesheet">
            <link href="http://bootstrapstyler.com/preview/_/boardskin/templates/bootstyler/templates/bootstyler/bootstrap/js/style.css" rel="stylesheet">
    </head>
    <body>
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                ...
                <a href="http://bootstrapstyler.com/preview/_/boardskin/templates/bootstyler/templates/bootstyler/bootstrap/js/" class="brand">BootstrapStyler</a>
                <div id="main-menu" class="nav-collapse">
                    ...
                    <iframe id="preview" src="http://bootstrapstyler.com/preview/_/boardskin/templates/bootstyler/templates/bootstyler/bootstrap/js/frontpage.php" frameborder="0" width="100%">
                    </iframe>


            <script src="http://bootstrapstyler.com/preview/_/boardskin/templates/bootstyler/templates/bootstyler/bootstrap/templates/bootstyler/js/jquery-1.8.0.min.js"></script>
            <script src="http://bootstrapstyler.com/preview/_/boardskin/templates/bootstyler/templates/bootstyler/bootstrap/templates/bootstyler/bootstrap/js/bootstrap.min.js"></script>
            <script>
                    ...
                    $(document).ready(function(){
                        ...
                        $('#theme-selector a').click(function(){
                            ...
                            var domainName = 'http://bootstrapstyler.com//preview/_/boardskin/templates/bootstyler/templates/bootstyler/bootstrap/js/bootstrap.min.js';
                        ...
                        $('#color-selector a').live( 'click', function(){
                            ...
                            $('#preview').contents().find('head link[href*="http://bootstrapstyler.com//preview/_/boardskin/templates/bootstyler/templates/bootstyler/bootstrap/js/bootstrap.min.js/_/'+templateName+'/css/styler/color/"]').remove();

                            // append new color stylesheet
                            $('#preview').contents().find('head').append('<link href="http://bootstrapstyler.com//preview/_/boardskin/templates/bootstyler/templates/bootstyler/bootstrap/js/bootstrap.min.js/_/'+templateName+'/css/styler/color/'+color+'.css?'+ timestamp +'" rel="stylesheet" />');
                            return true;
                        });
                    });
