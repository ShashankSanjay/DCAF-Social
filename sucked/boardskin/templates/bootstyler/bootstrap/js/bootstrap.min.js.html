...
<html lang="en-us">
    <head>
            ...
            <link href="../templates/2013/bootstrap/css/bootstrap.min.css" rel="stylesheet">
            <link href="../templates/2013/images/icons/css/font-awesome.css" rel="stylesheet">
    ...
    <body>
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                ...
                <a href="index.html" class="brand">BootstrapStyler</a>
                <div id="main-menu" class="nav-collapse">
                    <ul id="main-menu-left" class="nav pull-right">
                        ...
                        <li class="join"><a href="../../../../../../../index.html#join" id="swatch-link">Join Now</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <iframe id="preview" src="frontpage.php.html" frameborder="0" width="100%">
                    </iframe>


            <script src="../templates/bootstyler/js/jquery-1.8.0.min.js"></script>
            <script src="../templates/bootstyler/bootstrap/js/bootstrap.min.js"></script>
            <script>
                    ...
                    $(document).ready(function(){
                        ...
                        $('#theme-selector a').click(function(){
                            ...
                            var domainName = 'http://bootstrapstyler.com//preview/_/boardskin/templates/bootstyler/bootstrap/js/bootstrap.min.js';
                        ...
                        $('#color-selector a').live( 'click', function(){
                            ...
                            $('#preview').contents().find('head link[href*="http://bootstrapstyler.com//preview/_/boardskin/templates/bootstyler/bootstrap/js/bootstrap.min.js/_/'+templateName+'/css/styler/color/"]').remove();

                            // append new color stylesheet
                            $('#preview').contents().find('head').append('<link href="http://bootstrapstyler.com//preview/_/boardskin/templates/bootstyler/bootstrap/js/bootstrap.min.js/_/'+templateName+'/css/styler/color/'+color+'.css?'+ timestamp +'" rel="stylesheet" />');
                            return true;
                        });
                    });
