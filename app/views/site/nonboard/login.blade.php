					...
					<div class="row">
						<div class="col-lg-4 col-md-6 col-lg-offset-4 col-md-offset-3">
							<ul class="list-inline align-center">
								...
								<li>
									<a href="{{ URL::to('user/create') }}">Create account</a>
								</li>
							</ul>
							...
							<ul class="nav nav-pills nav-justified">
								<li>
									<a href="#" class="social-network brand-facebook"> <i class="fa fa-facebook-square"></i>
										Facebook
									</a>
								</li>
								<li>
									<a href="#" class="social-network brand-gplus"> <i class="fa fa-google-plus-square"></i>
										Google+
									</a>
								</li>
								<li>
									<a href="#" class="social-network brand-twitter">
										<i class="fa fa-twitter-square"></i>
										Twitter
									</a>
								</li>
								<li>
									<a href="#" class="social-network brand-github">
