                                        ...
                                        <div class="portlet-body chat-widget">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="media">
                                                        <a class="pull-left" href="#">
                                                            <img class="media-object img-circle" src="{{ URL::to('/') }}/assets/img/user-profile-1.jpg" alt="">
                                                        </a>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="media">
                                                        <a class="pull-left" href="#">
                                                            <img class="media-object img-circle" src="{{ URL::to('/') }}/assets/img/profile-pic-small.jpg" alt="">
                                                        </a>
                                                        <div class="media-body">
