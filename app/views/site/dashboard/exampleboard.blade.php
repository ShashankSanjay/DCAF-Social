			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="stat-block stat-primary">
					...
					<div class="details">
						...
						<div class="description">Feedbacks</div>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
								...
								<div class="media">
									...
									<div class="media-body">
										...
										<ul class="list-inline">
											...
											<li>
												<a href="#" class="small">Comment</a>
											</li>
											<li>
												<a href="#" class="small">Share</a>
											</li>
											<li>
												<span class="muted small">about an hour ago</span>
											</li>
										</ul>

										<form class="form-inline form-comment">
											<div class="form-group">
												<input type="text" class="form-control input-sm" placeholder="Write a comment ..."></div>
										</form>
									</div>
								</div>
									...
									<div class="media-body">
										...
										<div class="media">
											...
											<div class="media-body">
												...
												<p>
													Umami seitan fashion axe, elit veniam whatever raw denim art party mumblecore jean shorts ad delectus eiusmod.
												</p>
