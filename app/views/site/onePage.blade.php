              ...
              <form accept-charset="UTF-8" role="form" action={{ URL::to('lookUp') }}>
                ...
                <div class="portlet portlet-orange">
                      ...
                      <div class="portlet-body">
                          <div class="table-responsive">
                              <table class="table table-hover text-dark-blue text-left">
                                  ...
                                  <tbody>
                                    @foreach ($results['words'] as $key => $result) 
                                      <tr>
                                          <td>{{ $key+1 }}</td>
                                          <td>{{ $result['text'] }}</td>
                                          <td>{{ $result['relevance'] }}</td>
                                          <td>{{ ucfirst($result['sentiment']['type']) }}</td>
                                      </tr>
                                    @endforeach
                                  </tbody>
                              </table>
                    ...
                    <div class="portlet-footer text-dark-blue">
                      <h5> The overall sentiment in this post is: <strong class={{ $results['overallSentiment']['score']>0 ? "text-success" : "text-danger"}}><i> {{ strtoupper($results['overallSentiment']['type']) }} </i></strong></h5>
                    </div>
                </div>
                @endif
