...
<body>
    <div class="welcome">
        ...
        <a href="<?= OAuth::authorize('twitter')->redirect('http://shashanksanjay.com/socialapp') ?>">Login with twitter<br></a>
        <a href="<?= OAuth::authorize('google')->redirect('http://shashanksanjay.com/socialapp') ?>">Login with google<br></a>
        <a href="<?= OAuth::authorize('tumblr')->redirect('http://shashanksanjay.com/socialapp') ?>">Login with tumblr<br></a>
