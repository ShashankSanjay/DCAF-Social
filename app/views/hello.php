...
<body>
    <div class="welcome">
        ...
        ?>
        <a href="<?php echo fix_url_base(OAuth::getAuthorizeUrl('facebook')->redirect($base_url.'/logino')->url->getUrl()); ?>">Login with facebook<br></a>
        <a href="<?php echo fix_url_base(OAuth::getAuthorizeUrl('twitter')->redirect($base_url.'/logino')->url->getUrl()); ?>">Login with twitter<br></a>
        <a href="<?php echo fix_url_base(OAuth::getAuthorizeUrl('google')->redirect($base_url.'/logino')->url->getUrl()); ?>">Login with google<br></a>
        <a href="<?php echo fix_url_base(OAuth::getAuthorizeUrl('tumblr')->redirect($base_url.'/logino')->url->getUrl()); ?>">Login with tumblr<br></a>
        <br>
