...
<body>
    <div class="welcome">
        ...
        <a href="<?= OAuth::authorize('facebook')->redirect('http://shashanksanjay.com/socialapp') ?>">Login with facebook</a>
        <a href="<?= OAuth::authorize('twitter')->redirect('http://shashanksanjay.com/socialapp') ?>">Login with twitter</a>
        <a href="<?= OAuth::authorize('google')->redirect('http://shashanksanjay.com/socialapp') ?>">Login with google</a>
        <a href="<?= OAuth::authorize('tumblr')->redirect('http://shashanksanjay.com/socialapp') ?>">Login with tumblr</a>
