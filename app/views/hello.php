...
<body>
    <div class="welcome">
        ...
        <a href="<?= OAuth::authorize('facebook')->redirect('http://shashanksanjay.com/socialapp') ?>">Login with facebook<br></a>
        <?php
            $base_url = "http://shashanksanjay.com/socialapp/";
            $parsed_url = parse_url(OAuth::authorize('twitter'));
            $path     = isset($parsed_url['path']) ? $parsed_url['path'] : ''; 
            $query    = isset($parsed_url['query']) ? '?' . $parsed_url['query'] : ''; 
            $fragment = isset($parsed_url['fragment']) ? '#' . $parsed_url['fragment'] : ''; 
            $twitter_url = "$path$query$fragment"; 
        ?>
        <a href="<?= $twitter_url ?>">Login with twitter<br></a>
        <a href="<?= OAuth::authorize('google')->redirect('http://shashanksanjay.com/socialapp') ?>">Login with google<br></a>
        <a href="<?= OAuth::authorize('tumblr')->redirect('http://shashanksanjay.com/socialapp/login') ?>">Login with tumblr<br></a>
        <a href="<?= OAuth::login('twitter')->redirect('http://shashanksanjay.com/socialapp/logino'); ?>">Link with <?= Str::studly('twitter') ?></a>
