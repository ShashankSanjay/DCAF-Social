			...
			<ul class="nav nav-pills nav-stacked">
				...
				<li>
					...
					<ul class="panel-collapse collapse in" id="tasks">
						<li class="active"><a href="tasks"><i class="fa fa-arrow-right"></i> Task inside Panel</a></li>
										...
										<div class="row table-form">
											<div class="col-lg-12">
												<form class="form-horizontal">
													<div class="form-group">
														<div class="col-md-10">
															<input type="text" name="task-title" id="task-title" class="form-control" placeholder="Add item to Marketing">
														</div>
										...
										<div class="row table-form">
											<div class="col-lg-12">
												<form class="form-horizontal">
													<div class="form-group">
														<div class="col-md-10">
															<input type="text" name="task-title" id="task-title" class="form-control" placeholder="Add item to Web Design">
														</div>
										...
										<div class="row table-form">
											<div class="col-lg-12">
												<form class="form-horizontal">
													<div class="form-group">
														<div class="col-md-10">
															<input type="text" name="task-title" id="task-title" class="form-control" placeholder="Add item to Human Resource">
														</div>
