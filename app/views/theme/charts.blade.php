...
<div id="middle">
	...
	<div id="content">
		<div class="container">
			<div class="row">
				<div class="statistic-list-icon col-lg-3 col-md-3 col-sm-6">
					<div class="panel panel-outline">
						<div class="panel-heading">
							<h3 class="panel-title">Icon Statistics</h3>
						</div>
						<div class="panel-body">
							<ul class="listing list-unstyled">
								<li>
								  <label class="label-warning"><i class="fa fa-video-camera"></i></label>
								  <h4>375</h4>
								  <p class="sub">Videos</p>
								</li>
								<li>
								  <label class="label-danger"><i class="fa fa-comment"></i></label>
								  <h4>103</h4>
								  <p class="sub">Comments</p>
								</li>
								<li>
								  <label class="label-success"><i class="fa fa-camera-retro"></i></label>
								  <h4>92</h4>
								  <p class="sub">Photos</p>
								</li>
								<li>
								  <label class="label-info"><i class="fa fa-bell"></i></label>
								  <h4>865</h4>
				...
				<div class="statistic-list-chart col-lg-3 col-md-3 col-sm-6">
					<div class="panel panel-outline">
						<div class="panel-heading">
				...
				<div class="statistic-list-chart col-lg-3 col-md-3 col-sm-6">
					<div class="panel panel-outline">
						...
						<div class="panel-body">
							<ul class="listing list-unstyled">
								<li>
									<span class="inlineline">1,3,4,5,3,5,2</span>
									<h4>65</h4>
									<p class="sub">Signups</p>
								</li>
								<li>
									<span class="inlineline">1,4,4,7,5,9,10</span> 
									<h4>34</h4> 
									<p class="sub">Comments</p>
								</li>
								<li>
				...
				<div class="statistic-list-chart col-lg-3 col-md-3 col-sm-6">
					<div class="panel panel-outline">
						...
						<div class="panel-body">
							<ul class="listing list-unstyled">
								<li>
									<span class="inlinebar2">4,3,8,5,10,7,12</span>
									<h4>65</h4>
									<p class="sub">Signups</p>
								</li>
								<li>
									<span class="inlinebar2">1,3,4,5,3,5,2</span> 
									<h4>34</h4> 
									<p class="sub">Comments</p>
								</li>
								<li>
									<span class="inlinebar2">3,5,8,10,8,5,7</span>
									<h4>99</h4>
									<p class="sub">Photos</p>
								</li>
								<li>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6">
					<div class="panel panel-outline">
						<div class="panel-heading">
							<h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Browser Statistic</h3>
						</div><!-- /.panel-heading -->
						<div class="panel-body">
							<div id="browser_graph" style="height: 350px; width: 100%;"></div>
						</div><!-- /.panel-body -->
					</div><!-- /.panel-default -->
				</div><!-- /.col-lg-6 -->
				...
				<div class="col-lg-6 col-md-6">
					<div class="panel panel-outline">
						<div class="panel-heading">
							<h3 class="panel-title"><i class="fa fa-group"></i> Visitors</h3>
						</div><!-- /.panel-heading -->
						<div class="panel-body">
							<div id="visitor_graph" style="height: 150px; width: 100%;"></div>
						</div><!-- /.panel-body -->
					</div><!-- /.panel-outline -->
					...
					<div class="panel panel-outline">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-4">
									<div class="sparkline-chart" id="sparkline-graph2"></div>
									<div class="align-center">Server Load</div>
								</div>
								<div class="col-lg-4">
									<div class="sparkline-chart" id="sparkline-graph3"></div>
									<div class="align-center">RAM Usage</div>
								</div>
								<div class="col-lg-4">
									<div class="sparkline-chart" id="sparkline-graph4"></div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-outline">
						<div class="panel-heading">
							<h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Visitors by Countries</h3>
							<div class="panel-utility pull-right">
								<!-- Nav tabs -->
								<ul class="nav nav-pills navigator">
									<li><a href="#" class="zoomin"><i class="fa fa-plus"></i></a></li>
									<li><a href="#" class="zoomout"><i class="fa fa-minus"></i></a></li>
								</ul>
							</div>
						</div><!-- /.panel-heading -->
						<div class="panel-body">
							<div id="vector_map" style="width: 100%; height: 500px;"></div>
						</div><!-- /.panel-body -->
					</div><!-- /.panel-outline -->
				</div><!-- /.col-lg-12 -->
			</div><!-- /.row -->
