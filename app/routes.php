...
Route::get('/fballpages', function ()
{
	...
	*/
	...
	foreach ($pageIDs as $key => $page)
	{
		...
		curl_setopt($ch, CURLOPT_POSTFIELDS, '/?access_token=' . $data[0]['access_token'] . '&batch=[{"method":"GET", "relative_url":"me/' . $page . '?fields=id,access_token,likes,admins,albums,conversations,events,feed,insights,links,locations,posts,questions,statuses,tagged,videos"}]');
